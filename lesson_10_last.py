...
update=tf.group(centroids.assign(means),cluster_labels.assign(centroid_group))#assign 赋值
init=tf.global_variables_initializer()

sess.run(init)
for i in range(generations):
    print('calculation gen {},out of {}.'.format(i,generations))
...
dist, indexes = mytree.query(xy_pts)#递归 临近 中值 kd树
